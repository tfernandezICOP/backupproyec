...
public class ClientesTotales extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Nombre y Apellido", "Documento", "N° Telefono", "Correo Electronico"
            }
        ));
   ...
   private void darDeBajaCliente() {
    ...
    // Obtiene el valor de la columna que contiene el número de documento del cliente
    ...
    if (numeroDocumentoObj != null) {
        try {
            ...
            if (opcion == JOptionPane.YES_OPTION) {
                // Llama al método correspondiente de la controladora para dar de baja al cliente por número de documento
            ...
            JOptionPane.showMessageDialog(null, "Error al convertir el número de documento.");
        }
    } else {
        // Manejo de error si el valor es nulo
        JOptionPane.showMessageDialog(null, "El número de documento es nulo.");
    }
}
